...
JDK_VERSION="1.8.0.232.b09-11.0.5.10"
MAVEN_VERSION="3.6.2"
BASE_IMAGE_VERSION="${JDK_VERSION}-${MAVEN_VERSION}-b3244"
...
PACKAGES="python2 python3 libxslt rsync gettext tree wget git-core openssh-clients which expect make cmake gcc-c++ jq rrdtool-devel automake libtool rpm-build redhat-rpm-config R-core jicmp jicmp6 jrrd2"
